...
namespace com.danliris.support.webapi.Controllers.v1.Ceisa.TPBController
{
    ...
    [ApiVersion("1.0")]
    [Route("v{version:apiVersion}/tpb/23")]
    [Authorize]
    public class BC23Controller : Controller
    {
        private static readonly string ApiVersion = "1.0";
        public readonly IServiceProvider serviceProvider;
        public readonly IMapper Mapper;
        private IBC23 bC23Service;
        private readonly IdentityService identityService;
        public BC23Controller(IBC23 bC23Service, IServiceProvider serviceProvider, IMapper mapper)
        {
            this.bC23Service = bC23Service;
        ...
        public IActionResult Get(int page, int size, string keyword, string filter, string Order = "{}")
        {
            try
            {
                ...
                var data = bC23Service.Read(page, size, Order, keyword, filter);
        ...
        public async Task<IActionResult> Post([FromBody] TPBHeader model)
        {
            try
            {
                ...
                await bC23Service.Create(model);
        ...
        public async Task<IActionResult> GetById(long id)
        {
            try
            {
                ...
                var data = await bC23Service.ReadById(id);
        ...
        public async Task<IActionResult> Put(int id, [FromBody] TPBHeader viewModel)
        {
            try
            {
                ...
                await bC23Service.UpdateAsync(id, viewModel);
                return Ok(new
                {
                    apiVersion = ApiVersion,
        ...
        public async Task<IActionResult> PostToSupport(int id, [FromBody] TPBViewModelList viewModel)
        {
            try
            {
                ...
                await bC23Service.PostToSupportTPB(id, viewModel);
                return Ok(new
                {
                    apiVersion = ApiVersion,
                    message = General.UPDATE_MESSAGE,
