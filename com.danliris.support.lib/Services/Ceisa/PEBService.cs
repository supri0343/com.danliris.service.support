...
namespace com.danliris.support.lib.Services.Ceisa
{
    public class PEBService : IPEBService
    {
        ...
        public PEBViewModelList ReadByIdToPush(long id,string auth)
        {
            ...
            //PRD
            //var Respon = CeisaService.GetRespon(Query.Select(x => x.nomorAju).ToString(), auth);

            var Respon =  CeisaService.GetRespon(aju, token).Result;
