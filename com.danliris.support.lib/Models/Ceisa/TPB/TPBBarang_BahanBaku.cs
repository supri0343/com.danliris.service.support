...
{
    public class TPBBarang_BahanBaku : StandardEntity<long>
    {
        ...
        public string nomorAjuDokAsal { get; set; }
        ...
        public virtual IEnumerable<TPBBarang_BahanBakuTarif> bahanBakuTarif { get; set; }
    }
}
