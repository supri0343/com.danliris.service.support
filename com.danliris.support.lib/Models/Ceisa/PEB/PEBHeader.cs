...
{
    public class PEBHeader : BaseModel
    {
        ...
        public virtual IEnumerable<PEBBarang> barang { get; set; }
        public virtual IEnumerable<PEBEntitas> entitas { get; set; }
        public virtual IEnumerable<PEBKemasan> kemasan { get; set; }
        public virtual IEnumerable<PEBKontainer> kontainer { get; set; }
        public virtual IEnumerable<PEBDokumen> dokumen { get; set; }
        public virtual IEnumerable<PEBPengangkut> pengangkut { get; set; }
        public virtual IEnumerable<PEBBankDevisa> bankDevisa { get; set; }
        public virtual IEnumerable<PEBKesiapanBarang> kesiapanBarang { get; set; }
